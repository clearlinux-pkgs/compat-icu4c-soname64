...
Requires: compat-icu4c-soname64-lib = %{version}-%{release}
Requires: compat-icu4c-soname64-license = %{version}-%{release}
...
%package lib
Summary: lib components for the compat-icu4c-soname64 package.
Group: Libraries
Requires: compat-icu4c-soname64-license = %{version}-%{release}

%description lib
lib components for the compat-icu4c-soname64 package.


%package lib32
Summary: lib32 components for the compat-icu4c-soname64 package.
Group: Default
Requires: compat-icu4c-soname64-license = %{version}-%{release}

%description lib32
lib32 components for the compat-icu4c-soname64 package.


%package license
Summary: license components for the compat-icu4c-soname64 package.
Group: Default

%description license
license components for the compat-icu4c-soname64 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598472690
...
export SOURCE_DATE_EPOCH=1598472690
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-icu4c-soname64
cp %{_builddir}/icu/license.html %{buildroot}/usr/share/package-licenses/compat-icu4c-soname64/06e7821c4127e21850f5c981698443b6f31e0ef1
pushd ../build32/source
%make_install32
...
rm -f %{buildroot}/usr/lib32/icu/64.2/Makefile.inc
rm -f %{buildroot}/usr/lib32/icu/64.2/pkgdata.inc
...
rm -f %{buildroot}/usr/lib64/icu/64.2/Makefile.inc
rm -f %{buildroot}/usr/lib64/icu/64.2/pkgdata.inc
...
rm -f %{buildroot}/usr/share/icu/64.2/LICENSE
rm -f %{buildroot}/usr/share/icu/64.2/config/mh-linux
rm -f %{buildroot}/usr/share/icu/64.2/install-sh
rm -f %{buildroot}/usr/share/icu/64.2/mkinstalldirs
...
/usr/share/package-licenses/compat-icu4c-soname64/06e7821c4127e21850f5c981698443b6f31e0ef1
